    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="index_admin.php?page=job_application_form">
              <i class="bi bi-circle"></i><span>Job Application Form</span>
            </a>
          </li>
          <li>
            <a href="index_admin.php?page=registration_form" class="active">
              <i class="bi bi-circle"></i><span>Registation Form</span>
            </a>
          </li>
          <li>
            <a href="index_admin.php?page=feedback_form" class="active">
    ...
    if (isset($_GET['page'])) {
      ...
      switch ($page) {
        ...
        case 'registration_form':
          ...
          break;
        case 'feedback_form':
          include 'modules/consultation_form.php';
          break;
          case 'job_application_form':
          include 'modules/job_application_form.php';
          break;
